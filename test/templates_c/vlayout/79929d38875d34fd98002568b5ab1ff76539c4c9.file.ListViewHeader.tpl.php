<?php /* Smarty version Smarty-3.1.7, created on 2016-09-08 14:01:54
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Potentials/ListViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:87102969257bd5db9bce698-85039161%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79929d38875d34fd98002568b5ab1ff76539c4c9' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Potentials/ListViewHeader.tpl',
      1 => 1473332512,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '87102969257bd5db9bce698-85039161',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57bd5db9ca7bf',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_57bd5db9ca7bf')) {function content_57bd5db9ca7bf($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['a']->value==2){?><span class="btn-group hide"><button id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
</strong></button></span><?php }?><?php } ?><span class="btn-group"><button id="leads_mass_transfer" class="btn addButton" onclick="Potentials_mass_transfer(event)"><i class="icon-refresh"></i>&nbsp;<strong>Передать Бронь</strong></button></span></span><span class="btn-toolbar span4"><span class="customFilterMainSpan btn-group"><?php if (count($_smarty_tpl->tpl_vars['CUSTOM_VIEWS']->value)>0){?><select id="customFilter" style="width:350px;"><?php  $_smarty_tpl->tpl_vars['GROUP_CUSTOM_VIEWS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['GROUP_CUSTOM_VIEWS']->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->get('cvid')==10){?> <?php continue 1?><?php }?><option  data-editurl="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getEditUrl();?>
