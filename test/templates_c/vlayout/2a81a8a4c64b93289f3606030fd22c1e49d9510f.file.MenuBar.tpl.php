<?php /* Smarty version Smarty-3.1.7, created on 2017-05-31 07:03:02
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1239559011118a6f3a7-96320215',
  'function' => 
  array (
  ),
...
&nbsp;</strong><b class="caret"></b></a><div class="dropdown-menu"><div class="shortDropdown"><label class="moduleNames"><a id="report_leads" href="index.php?module=VDCustomReports&view=List&mode=getLeadsReport">Заявки</a></label><label class="moduleNames"><a id="report_bron" href="index.php?module=VDCustomReports&view=List&mode=getBookingReport">Брони</a></label><label class="moduleNames"><a id="report_stat" href="index.php?module=VDCustomReports&view=List&mode=getStatistic">Статистика</a></label><label class="moduleNames"><a id="report_avg" href="index.php?module=VDCustomReports&view=List&mode=getAverage">Средний чек</a></label><label class="moduleNames"><a id="report_proceeds" href="index.php?module=VDCustomReports&view=List&mode=getProceeds">Выручка и Доход</a></label><label class="moduleNames"><a id="sales_plan" href="index.php?module=VDCustomReports&view=List&mode=getSalesPlan">План продаж</a></label><label class="moduleNames"><a id="sales_funnel" href="index.php?module=VDCustomReports&view=List&mode=getSalesFunnel">Воронка продаж</a></label></div></div></li></ul><ul class="nav" id="commonMoreMenu234"><li class="dropdown" id="moreMenu234"><a class="dropdown-toggle" data-toggle="dropdown" href="#moreMenu234" style="color:#fff"><strong><?php echo vtranslate('Бухгалтерия',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;</strong><b class="caret"></b></a><div class="dropdown-menu"><div class="shortDropdown"><label class="moduleNames"><a href="/index.php?module=Accounting&view=List&mode=workingHours">Учет рабочего времени</a></label><label class="moduleNames"><a href="/index.php?module=Accounting&view=List&mode=vacationSchedule">График отпусков</a></label><label class="moduleNames"><a href="/index.php?module=Accounting&view=List&mode=holidays">Праздничные дни</a></label></div></div></li></ul></div><div class="span3 marginLeftZero pull-right" id="headerLinks"><span id="headerLinksBig" class="pull-right headerLinksContainer"><span class="dropdown span settingIcons"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><img src="<?php echo vimage_path('theme_brush.png');?>
