<?php /* Smarty version Smarty-3.1.7, created on 2017-05-18 23:55:45
...
&nbsp;</strong><b class="caret"></b></a><div class="dropdown-menu"><div class="shortDropdown"><label class="moduleNames"><a id="report_leads" href="/index.php?module=Accounting&view=List&mode=workingHours">Учет рабочего времени</a></label></div></div></li></ul></div><div class="span3 marginLeftZero pull-right" id="headerLinks"><span id="headerLinksBig" class="pull-right headerLinksContainer"><span class="dropdown span settingIcons"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><img src="<?php echo vimage_path('theme_brush.png');?>
