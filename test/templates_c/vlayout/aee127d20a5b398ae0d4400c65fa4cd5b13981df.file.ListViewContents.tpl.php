<?php /* Smarty version Smarty-3.1.7, created on 2016-08-26 17:26:02
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Suggestions/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:199297046857c01c3b19e4e6-81934253%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aee127d20a5b398ae0d4400c65fa4cd5b13981df' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Suggestions/ListViewContents.tpl',
      1 => 1472221559,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '199297046857c01c3b19e4e6-81934253',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57c01c3b2493f',
  'variables' => 
  array (
    'VIEW' => 0,
    'PAGING_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_57c01c3b2493f')) {function content_57c01c3b2493f($_smarty_tpl) {?>
...
<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
<?php }?><?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='script'){?><a href="index.php?module=VDDialogueDesigner&view=RunScript&record=<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
" target="_blank">Перейти на скрипт</a>&nbsp;&nbsp;||&nbsp;&nbsp;<a href="index.php?module=VDDialogueDesigner&view=Edit&record=<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
" >Открыть коструктор</a><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType()=='double'){?><?php echo decimalFormat($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value));?>
