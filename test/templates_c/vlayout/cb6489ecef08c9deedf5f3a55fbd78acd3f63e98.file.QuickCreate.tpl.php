<?php /* Smarty version Smarty-3.1.7, created on 2016-08-26 14:30:10
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Suggestions/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:75796974757c025cee27421-32184087%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb6489ecef08c9deedf5f3a55fbd78acd3f63e98' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Suggestions/QuickCreate.tpl',
      1 => 1472210997,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '75796974757c025cee27421-32184087',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57c025cee9f79',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
<?php if ($_valid && !is_callable('content_57c025cee9f79')) {function content_57c025cee9f79($_smarty_tpl) {?>
...
"></script><?php } ?><div class="modelContainer" style="width:800px;"><div class="modal-header contentsBackground"><button class="close" aria-hidden="true" data-dismiss="modal" type="button" title="<?php echo vtranslate('LBL_CLOSE');?>
...
</a><button class="btn btn-success" onclick="SaveSuggections(event);return false;"><strong><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button></div></form></div>

    <style>
    .massEditTable > tbody:nth-child(1) > tr:nth-child(1), .massEditTable > tbody:nth-child(1) > tr:nth-child(2){
    display:none;
}
    </style>
<?php }} ?>