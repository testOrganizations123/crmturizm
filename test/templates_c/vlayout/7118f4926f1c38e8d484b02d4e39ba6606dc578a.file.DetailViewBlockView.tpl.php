<?php /* Smarty version Smarty-3.1.7, created on 2016-08-26 16:10:14
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Suggestions/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:38411535457c03f8b783306-61192775%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7118f4926f1c38e8d484b02d4e39ba6606dc578a' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Suggestions/DetailViewBlockView.tpl',
      1 => 1472217005,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '38411535457c03f8b783306-61192775',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57c03f8b89755',
  'variables' => 
  array (
    'RECORD_STRUCTURE' => 0,
    'BLOCK_LABEL_KEY' => 0,
...
<?php if ($_valid && !is_callable('content_57c03f8b89755')) {function content_57c03f8b89755($_smarty_tpl) {?>
...
" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='19'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='20'){?> colspan="3" <?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?> <?php }?>><?php if ($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='script'){?><a href="index.php?module=VDDialogueDesigner&view=RunScript&record=<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue');?>
" target="_blank">Перейти на скрипт</a>&nbsp;&nbsp;||&nbsp;&nbsp;<a href="index.php?module=VDDialogueDesigner&view=Edit&record=<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue');?>
" >Открыть коструктор</a><?php }else{ ?><span class="value" data-field-type="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType();?>
