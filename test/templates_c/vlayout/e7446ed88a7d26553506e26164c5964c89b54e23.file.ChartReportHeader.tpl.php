<?php /* Smarty version Smarty-3.1.7, created on 2016-10-03 12:00:26
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Reports/ChartReportHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:172734711157c056976de715-21057544%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7446ed88a7d26553506e26164c5964c89b54e23' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Reports/ChartReportHeader.tpl',
      1 => 1475398071,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '172734711157c056976de715-21057544',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57c0569778241',
  'variables' => 
  array (
    'LEFTPANELHIDE' => 0,
    'DATE_FILTERS' => 0,
...
<?php if ($_valid && !is_callable('content_57c0569778241')) {function content_57c0569778241($_smarty_tpl) {?>
...
</strong></button></div><div class="btn-group"><?php if (count($_smarty_tpl->tpl_vars['WIDGET']->value)>1){?><button onclick='Vtiger_Detail_Js.deleteWidgetReports(this)' data-id="<?php echo $_smarty_tpl->tpl_vars['WIDGET']->value['linkid'];?>
" type="button" class="cursorPointer btn btn-success"><strong><?php echo vtranslate('Widget',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button><?php }else{ ?><button onclick='Vtiger_Detail_Js.registerWidgetReports(this);' data-name='<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getName());?>
' data-id="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value;?>
" type="button" class="cursorPointer btn"><strong><?php echo vtranslate('Widget',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button><?php }?></div></div></div></div><div class="well"><form name='chartDetailForm' id='chartDetailForm'><input type="hidden" name="module" value="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
