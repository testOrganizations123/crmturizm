<?php /* Smarty version Smarty-3.1.7, created on 2016-07-21 17:50:27
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Settings/VDDialogueDesigner/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1382348497578a4b0769f9b0-39769349%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d7ae3b5e606198883af703476519aefedd128e0' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Settings/VDDialogueDesigner/ListViewContents.tpl',
      1 => 1469109826,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1382348497578a4b0769f9b0-39769349',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_578a4b077da00',
  'variables' => 
  array (
    'PAGING_MODEL' => 0,
    'LISTVIEW_COUNT' => 0,
...
<?php if ($_valid && !is_callable('content_578a4b077da00')) {function content_578a4b077da00($_smarty_tpl) {?>
...
$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->_loop = true;
 $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->iteration++;
 $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->last = $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->iteration === $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->total;
?><?php $_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME'] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name'), null, 0);?><?php $_smarty_tpl->tpl_vars['LAST_COLUMN'] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->last, null, 0);?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='color'){?><td class="listViewEntryValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"  width="<?php echo $_smarty_tpl->tpl_vars['WIDTH']->value;?>
%" nowrap>&nbsp;<span style="border:2px solid #000000; background-color: <?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getDisplayValue($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> <?php echo vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getDisplayValue($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"></i></a><?php if (!$_smarty_tpl->tpl_vars['RECORD_LINK']->last){?>&nbsp;&nbsp;<?php }?><?php } ?></span></div></td><?php }?></td><?php }else{ ?><td class="listViewEntryValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"  width="<?php echo $_smarty_tpl->tpl_vars['WIDTH']->value;?>
...
' <?php }?>><i class="<?php echo $_smarty_tpl->tpl_vars['RECORD_LINK']->value->getIcon();?>
 alignMiddle" title="<?php echo vtranslate($_smarty_tpl->tpl_vars['RECORD_LINK']->value->getLabel(),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"></i></a><?php if (!$_smarty_tpl->tpl_vars['RECORD_LINK']->last){?>&nbsp;&nbsp;<?php }?><?php } ?></span></div></td><?php }?></td><?php }?><?php } ?></tr><?php } ?></tbody></table><!--added this div for Temporarily --><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value=='0'){?><table class="emptyRecordsDiv"><tbody><tr><td><?php echo vtranslate('LBL_NOT_FOUND',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
