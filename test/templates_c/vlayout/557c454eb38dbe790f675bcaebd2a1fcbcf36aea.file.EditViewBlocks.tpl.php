<?php /* Smarty version Smarty-3.1.7, created on 2016-08-26 17:13:34
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Suggestions/EditViewBlocks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:213268826857c0403685d6b6-09503443%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '557c454eb38dbe790f675bcaebd2a1fcbcf36aea' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Suggestions/EditViewBlocks.tpl',
      1 => 1472217173,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '213268826857c0403685d6b6-09503443',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57c04036947cc',
  'variables' => 
  array (
    'USER_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_57c04036947cc')) {function content_57c04036947cc($_smarty_tpl) {?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['isReferenceField']->value!="reference"){?></label><?php }?></td><?php if ($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='script'){?><td class="fieldValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='19'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='20'){?> colspan="3" <?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?> <?php }?>><a href="index.php?module=VDDialogueDesigner&view=RunScript&record=<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue');?>
...
" target="_blank">Открыть коструктор</a></td><?php }elseif($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="83"){?><td class="fieldValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
