<?php /* Smarty version Smarty-3.1.7, created on 2017-01-09 13:03:32
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Leads/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:73544580158172e8ee03c88-84695772%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0aa55be8949202b7837fbab33aebff9d6296def9' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Leads/DetailViewBlockView.tpl',
      1 => 1483893232,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '73544580158172e8ee03c88-84695772',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_58172e8eef5fd',
  'variables' => 
  array (
    'RECORD_STRUCTURE' => 0,
    'BLOCK_LABEL_KEY' => 0,
...
<?php if ($_valid && !is_callable('content_58172e8eef5fd')) {function content_58172e8eef5fd($_smarty_tpl) {?>
...
" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='description'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='69'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='cf_1085'){?> style='width:8%'<?php }?>><label align="right" class="muted pull-right marginRight10px"><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label');?>
...
<?php }?></span><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='Users'&&($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='spcompany'||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=='office'||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=='add_user')&&!$_smarty_tpl->tpl_vars['USER_MODEL']->value->isAdminUser()){?><?php }elseif(($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='Leads'||$_smarty_tpl->tpl_vars['MODULE_NAME']->value=='Potentials')&&$_smarty_tpl->tpl_vars['FIELD_NAME']->value=='assigned_user_id'){?><?php }elseif($_smarty_tpl->tpl_vars['IS_AJAX_ENABLED']->value&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable()=='true'&&($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()!=Vtiger_Field_Model::REFERENCE_TYPE)&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isAjaxEditable()=='true'){?><?php if (($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='rating'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')=='Скидочник')||($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='leadstatus'&&trim($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue'))=='Готов купить тур')){?><?php $_smarty_tpl->tpl_vars['ADDTEXTINFO'] = new Smarty_variable('При приезде туриста повторно, следует идти по скрипту "работа с туристом-скидочником с шага "Готов купить тур"', null, 0);?><?php }else{ ?><span class="hide edit"><?php if ($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='office'){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('uitypes/office.tpl',$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='multipicklist'){?><input type="hidden" class="fieldname" value='<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name');?>
...
' /><?php }?></span><?php }?><?php }?></td><?php }?><?php if (count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)==1&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="19"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="20"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="30"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!="recurringtype"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="69"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="105"){?><td class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
