<?php /* Smarty version Smarty-3.1.7, created on 2016-09-01 13:52:15
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Users/UserViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1329052457578118c71de913-90819011%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c51ef8ed71fc66618a0788c629be38adca52ef70' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Users/UserViewHeader.tpl',
      1 => 1472727130,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1329052457578118c71de913-90819011',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_578118c729d75',
  'variables' => 
  array (
    'MODULE_MODEL' => 0,
    'RECORD' => 0,
...
<?php if ($_valid && !is_callable('content_578118c729d75')) {function content_578118c729d75($_smarty_tpl) {?>
<?php $_smarty_tpl->tpl_vars["MODULE_NAME"] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->get('name'), null, 0);?><input id="recordId" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
" /><div class="detailViewContainer"><div class="detailViewTitle" id="userPageHeader"><div class="row-fluid"><div class="span6"><span class="row-fluid marginLeftZero"><span class="span2"><?php  $_smarty_tpl->tpl_vars['IMAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = false;
...
</h3></span></span></span></div><div class="span6"><div class="row-fluid pull-right detailViewButtoncontainer"><div class="btn-toolbar pull-right"><?php  $_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->_loop = false;
...
"><a href=<?php echo $_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getUrl();?>
 ><?php echo vtranslate($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a></li><?php }?><?php } ?></ul></span><?php }?><?php $_smarty_tpl->tpl_vars['privelege'] = new Smarty_variable(explode('::',$_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->getParentRoleSequence()), null, 0);?><?php if (count($_smarty_tpl->tpl_vars['privelege']->value)<5){?><span class="btn-group"><button id="leads_mass_transfer" class="btn addButton" onclick="Paritet_mass_transfer(event)"><i class="icon-refresh"></i>&nbsp;<strong>Паритетная передача</strong></button></span><?php }?></div></div></div></div></div><div class="detailViewInfo userPreferences row-fluid"><div class="details span12"><form id="detailView" data-name-fields='<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getNameFields());?>
