<?php /* Smarty version Smarty-3.1.7, created on 2016-10-03 10:27:27
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Reports/ReportHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:742528527579497df1835a7-38170554%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2fcb3ecce92780d22ca3df567be800da74d40945' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Reports/ReportHeader.tpl',
      1 => 1475398108,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '742528527579497df1835a7-38170554',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_579497df2092d',
  'variables' => 
  array (
    'LEFTPANELHIDE' => 0,
    'DATE_FILTERS' => 0,
...
<?php if ($_valid && !is_callable('content_579497df2092d')) {function content_579497df2092d($_smarty_tpl) {?>
...
</strong></button></div><?php } ?></div></span></div></div><br><div class="row-fluid"><?php if ($_smarty_tpl->tpl_vars['SQL_QUERY']->value){?><div class="row-fluid block padding1per"><input id="sql_validate" value="1" name="sql_validate" type="hidden" /><input id="sql_RECORD_ID" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
" name="sql_validate" type="hidden" /><table class="table table-bordered blockContainer showInlineTable equalSplit"><?php  $_smarty_tpl->tpl_vars['FIELD_SQL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_SQL']->_loop = false;
...
</label></td><td class="fieldValue large"><span class="span10"><input class="large selected_fields" name="selected_fields[inputs][]" <?php if ($_smarty_tpl->tpl_vars['FIELD_SQL']->value['required']){?>required<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['FIELD_SQL']->value['value'];?>
" /></span></td></tr><?php } ?></table></div><?php }else{ ?><input type="hidden" id="recordId" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
...
<?php }?><div class="row-fluid"><div class="textAlignCenter"><button class="btn generateReport" data-mode="generate" value="<?php echo vtranslate('LBL_GENERATE_NOW',$_smarty_tpl->tpl_vars['MODULE']->value);?>
