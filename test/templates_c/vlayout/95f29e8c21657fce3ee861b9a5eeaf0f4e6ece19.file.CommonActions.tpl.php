<?php /* Smarty version Smarty-3.1.7, created on 2016-09-12 12:53:43
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/CommonActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8489889475780eb927576d9-74421311%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95f29e8c21657fce3ee861b9a5eeaf0f4e6ece19' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/CommonActions.tpl',
      1 => 1473674018,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8489889475780eb927576d9-74421311',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5780eb928063e',
  'variables' => 
  array (
    'ANNOUNCEMENT' => 0,
    'USER_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_5780eb928063e')) {function content_5780eb928063e($_smarty_tpl) {?>

<?php $_smarty_tpl->tpl_vars["announcement"] = new Smarty_variable($_smarty_tpl->tpl_vars['ANNOUNCEMENT']->value->get('announcement'), null, 0);?><?php $_smarty_tpl->tpl_vars['count'] = new Smarty_variable(0, null, 0);?><?php $_smarty_tpl->tpl_vars["dateFormat"] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('date_format'), null, 0);?><div class="navbar commonActionsContainer noprint"><div class="actionsContainer row-fluid"><div class="span2" style="position:absolute;"><span class="companyLogo"><img src="<?php echo $_smarty_tpl->tpl_vars['COMPANY_LOGO']->value->get('imagepath');?>
...
"/>&nbsp;</span></div><div class="span10 pull-right" style="float:right"><div class="row-fluid"><div class="searchElement span8"><div class="select-search"><select class="chzn-select" id="basicSearchModulesList" style="width:150px;"><option value="" class="globalSearch_module_All"><?php echo vtranslate('LBL_ALL_RECORDS',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
