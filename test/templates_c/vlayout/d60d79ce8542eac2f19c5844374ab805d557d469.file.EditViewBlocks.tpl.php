<?php /* Smarty version Smarty-3.1.7, created on 2017-02-01 09:07:36
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/EditViewBlocks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:81676320557810dffa78231-58465486%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd60d79ce8542eac2f19c5844374ab805d557d469' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/EditViewBlocks.tpl',
      1 => 1485929166,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '81676320557810dffa78231-58465486',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57810dffc534e',
  'variables' => 
  array (
    'USER_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_57810dffc534e')) {function content_57810dffc534e($_smarty_tpl) {?>
...
" /><?php }?><input type="hidden" name="action" value="Save" /><input type="hidden" name="express" value="<?php echo $_smarty_tpl->tpl_vars['express']->value;?>
...
" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='19'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='20'){?> colspan="3" <?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?> <?php }?>><div class="row-fluid"><span class="span10"><?php if ($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='typevisa'){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('uitypes/typeturvisa.tpl',$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('BLOCK_FIELDS'=>$_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value), 0);?>
<?php }elseif($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='office'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Office'){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('uitypes/office.tpl',$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php $_smarty_tpl->tpl_vars['office'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue'), null, 0);?><?php }elseif($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='fosa_id'){?><?php echo $_smarty_tpl->tpl_vars['office']->value;?>
<?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('uitypes/fosa.tpl',$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
