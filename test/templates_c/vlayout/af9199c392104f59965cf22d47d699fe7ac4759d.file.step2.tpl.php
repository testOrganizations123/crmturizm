<?php /* Smarty version Smarty-3.1.7, created on 2016-10-03 14:00:33
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Reports/step2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:183459257457932ba80f74b6-11809871%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af9199c392104f59965cf22d47d699fe7ac4759d' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Reports/step2.tpl',
      1 => 1475492313,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '183459257457932ba80f74b6-11809871',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57932ba81e3de',
  'variables' => 
  array (
    'MODULE' => 0,
    'RECORD_ID' => 0,
...
<?php if ($_valid && !is_callable('content_57932ba81e3de')) {function content_57932ba81e3de($_smarty_tpl) {?>
<form class="form-horizontal recordEditView" id="report_step2" method="post" type="multipart/form-data" action="index.php"><input type="hidden" name="module" value="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
"><input type="hidden" class="step" value="2" /><div class="well padding1per contentsBackground"><?php if ($_smarty_tpl->tpl_vars['SQL_QUERY']->value){?><input id="sql_validate" value="1" name="sql_validate" type="hidden" /><div class="row-fluid block padding1per"><table class="table table-bordered blockContainer showInlineTable equalSplit"><tr><th class="blockHeader" colspan="2"><?php echo vtranslate('LBL_SELECT_SQL_QUERY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
?><tr><td class="fieldLabel small" style="width:10%"><label align="right" class="muted pull-right marginRight10px"><?php if ($_smarty_tpl->tpl_vars['FIELD_SQL']->value['required']){?><span class="redColor">*</span><?php }?><?php echo $_smarty_tpl->tpl_vars['FIELD_SQL']->value['name'];?>
</label></td><td class="fieldValue large" style="width:90%"><span class="span10"><textarea class="large" name="selected_fields[<?php echo $_smarty_tpl->tpl_vars['FIELD_SQL']->value['name'];?>
]" <?php if ($_smarty_tpl->tpl_vars['FIELD_SQL']->value['required']){?>required<?php }?> style="width:100%; min-height: 350px;"><?php echo $_smarty_tpl->tpl_vars['FIELD_SQL']->value['value'];?>
</textarea></span></td></tr><?php } ?></table></div><?php }else{ ?><div class="row-fluid block padding1per"><div class="row-fluid padding1per"><strong><?php echo vtranslate('LBL_SELECT_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
