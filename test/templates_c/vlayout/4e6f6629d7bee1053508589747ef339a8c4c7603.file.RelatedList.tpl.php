<?php /* Smarty version Smarty-3.1.7, created on 2016-09-06 16:08:13
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:794676463578137e2137fc1-41147057%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4e6f6629d7bee1053508589747ef339a8c4c7603' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedList.tpl',
      1 => 1473167118,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '794676463578137e2137fc1-41147057',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_578137e233ce4',
  'variables' => 
  array (
    'RELATED_MODULE' => 0,
    'PAGING' => 0,
...
<?php if ($_valid && !is_callable('content_578137e233ce4')) {function content_578137e233ce4($_smarty_tpl) {?>
...
</span></span></li></ul><button class="btn" id="relatedListNextPageButton" <?php if ((!$_smarty_tpl->tpl_vars['PAGING']->value->isNextPageExists())||($_smarty_tpl->tpl_vars['PAGE_COUNT']->value==1)){?> disabled <?php }?> type="button"><span class="icon-chevron-right"></span></button></span></div></div></div></div><div class="contents-topscroll"><div class="topscroll-div">&nbsp;<?php if (($_smarty_tpl->tpl_vars['MODULE']->value=='ListCountry'||$_smarty_tpl->tpl_vars['MODULE']->value=='TypeTourisVisa'||$_smarty_tpl->tpl_vars['MODULE']->value=='ListTouroperators')&&$_smarty_tpl->tpl_vars['bottom_copy']->value){?><div>Скопировать из: <select id='country_list'><?php  $_smarty_tpl->tpl_vars['country'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['country']->_loop = false;
 $_smarty_tpl->tpl_vars['id'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['bottom_copy']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
</option><?php } ?></select> &nbsp; <a href="#" onclick="relatedCopy()">Скопировать</a></div><?php }?></div></div><div class="relatedContents contents-bottomscroll"><div class="bottomscroll-div"><?php $_smarty_tpl->tpl_vars['WIDTHTYPE'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('rowheight'), null, 0);?><table class="table table-bordered listViewEntriesTable"><thead><tr class="listViewHeaders"><?php  $_smarty_tpl->tpl_vars['HEADER_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['HEADER_FIELD']->_loop = false;
