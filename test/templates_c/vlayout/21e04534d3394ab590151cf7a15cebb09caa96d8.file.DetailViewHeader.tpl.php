<?php /* Smarty version Smarty-3.1.7, created on 2017-01-31 15:06:28
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Leads/DetailViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:127439552257dfc8da1b9454-87652649%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '21e04534d3394ab590151cf7a15cebb09caa96d8' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Leads/DetailViewHeader.tpl',
      1 => 1485864373,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '127439552257dfc8da1b9454-87652649',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57dfc8da22c3a',
  'variables' => 
  array (
    'MODULE_MODEL' => 0,
    'RECORD' => 0,
...
<?php if ($_valid && !is_callable('content_57dfc8da22c3a')) {function content_57dfc8da22c3a($_smarty_tpl) {?>
<style>
    li[data-label-key="Activities"]{
    display:none;
    }
</style>
...
</div></div><div class="span7"><?php if ($_smarty_tpl->tpl_vars['ERROREDIT']->value&&$_smarty_tpl->tpl_vars['ERRORBUTTON']->value){?><div class="btn-toolbar pull-right"><span class="btn-group"><a class="btn" onclick="foulReady()">Замечание</a></span></div><?php }elseif($_smarty_tpl->tpl_vars['ERRORBUTTON']->value){?><div class="btn-toolbar pull-right"><span class="btn-group" id="createFoul"><a class="quickCreateModule btn" data-name="FoulList" data-url="index.php?module=FoulList&view=QuickCreateAjax&target=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
" href="javascript:void(0)">Добавить Замечание</a></span></div><?php }?><div class="pull-right detailViewButtoncontainer hide"><div class="btn-toolbar"><?php  $_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->_loop = false;
