<?php /* Smarty version Smarty-3.1.7, created on 2016-09-01 00:33:59
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Users/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:931975589578118bf07d679-38361213%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f68d7a048894783c37abae1694d6d42cebc7cc2a' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Users/ListViewContents.tpl',
      1 => 1472679235,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '931975589578118bf07d679-38361213',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_578118bf1ea2d',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_578118bf1ea2d')) {function content_578118bf1ea2d($_smarty_tpl) {?>
...
</a></td><?php } ?></tr></tbody></table></div><br><div class="listViewEntriesDiv listViewPageDiv" style='overflow-x:auto;'><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['ORDER_BY']->value;?>
...
" nowrap><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='office'){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('uitypes/officeList.tpl',$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('listvalue'=>$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value)), 0);?>
...
<?php }?><?php if (!$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->last){?></td><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->last){?><div class="pull-right actions"><span class="actionImages"><?php if ($_smarty_tpl->tpl_vars['IS_MODULE_EDITABLE']->value&&$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('status')=='Active'){?><a id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
