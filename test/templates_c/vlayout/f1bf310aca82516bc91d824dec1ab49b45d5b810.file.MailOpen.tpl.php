<?php /* Smarty version Smarty-3.1.7, created on 2017-03-11 13:59:58
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/MailManager/MailOpen.tpl" */ ?>
<?php /*%%SmartyHeaderCode:99660627158c3d8ae1a78b5-11158018%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f1bf310aca82516bc91d824dec1ab49b45d5b810' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/MailManager/MailOpen.tpl',
      1 => 1468060620,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '99660627158c3d8ae1a78b5-11158018',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58c3d8ae2d6d2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58c3d8ae2d6d2')) {function content_58c3d8ae2d6d2($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/moihottur/data/www/crmturizm.ru/libraries/Smarty/libs/plugins/modifier.escape.php';
?>
...
</h3></div></div><br><div class="row-fluid"><div class="btn-toolbar span10"><div class="btn-group"><button class="btn pull-left" onclick="MailManager.mail_close();" href='javascript:void(0);'><strong>&#171; <?php echo vtranslate($_smarty_tpl->tpl_vars['FOLDER']->value->name(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
