<?php /* Smarty version Smarty-3.1.7, created on 2016-10-11 11:51:59
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Settings/SharingAccess/Index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8583376445787464dbec9d2-17015676%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2308802ecfb59c3163964c5405f3b69d1be9a305' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Settings/SharingAccess/Index.tpl',
      1 => 1476175916,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8583376445787464dbec9d2-17015676',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5787464dc9652',
  'variables' => 
  array (
    'DEPENDENT_MODULES' => 0,
    'QUALIFIED_MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_5787464dc9652')) {function content_5787464dc9652($_smarty_tpl) {?>
...
</td><td class=""><div><input type="radio" disabled="disabled" /></div></td><td class=""><div><input type="radio" disabled="disabled" /></div></td><td class=""><div><input type="radio" disabled="disabled" /></div></td><td class=""><div><input type="radio" checked="true" disabled="disabled" /></div></td><td class="triggerCustomSharingAccess"><div class="row-fluid"><div class="span3">&nbsp;</div><div class="span6"><button type="button" class="btn btn-mini vtButton arrowDown row-fluid" data-handlerfor="fields" data-togglehandler="9-rules"><img src="layouts/vlayout/skins/images/Arrow-down.png"></img></button><button type="button" class="btn btn-mini vtButton arrowUp row-fluid hide" data-handlerfor="fields" data-togglehandler="9-rules"><img src="layouts/vlayout/skins/images/Arrow-up.png"></img></button></div></div></td></tr><?php  $_smarty_tpl->tpl_vars['MODULE_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['MODULE_MODEL']->_loop = false;
