<?php /* Smarty version Smarty-3.1.7, created on 2016-08-04 18:16:38
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/RecentComments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4769025465787ae50d16d51-80790318%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2738b4d1e30dde7b54d022f860279e5287092abf' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/RecentComments.tpl',
      1 => 1470323788,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4769025465787ae50d16d51-80790318',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5787ae50e1d79',
  'variables' => 
  array (
    'COMMENTS' => 0,
    'COMMENT' => 0,
...
<?php if ($_valid && !is_callable('content_5787ae50e1d79')) {function content_5787ae50e1d79($_smarty_tpl) {?>
...
..</a></div></div><?php }?><div class="commentTitle row-fluid"><?php if ($_smarty_tpl->tpl_vars['COMMENTS_MODULE_MODEL']->value->isPermitted('EditView')){?><div class="addCommentBlock"><div><textarea name="commentcontent" class="commentcontent"  placeholder="<?php echo vtranslate('LBL_ADD_YOUR_COMMENT_HERE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
</strong></button></div></div><?php }?></div><div class="hide basicAddCommentBlock"><div class="row-fluid"><span class="span1">&nbsp;</span><div class="span11"><textarea class="commentcontenthidden fullWidthAlways" name="commentcontent" rows="<?php echo $_smarty_tpl->tpl_vars['COMMENT_TEXTAREA_DEFAULT_ROWS']->value;?>
