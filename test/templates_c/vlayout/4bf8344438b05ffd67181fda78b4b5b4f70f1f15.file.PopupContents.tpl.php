<?php /* Smarty version Smarty-3.1.7, created on 2016-07-09 17:46:23
         compiled from "/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/PopupContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:183162410357810e3fabc7e3-74411195%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4bf8344438b05ffd67181fda78b4b5b4f70f1f15' => 
    array (
      0 => '/var/www/moihottur/data/www/crmturizm.ru/includes/runtime/../../layouts/vlayout/modules/Vtiger/PopupContents.tpl',
      1 => 1450875195,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '183162410357810e3fabc7e3-74411195',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57810e3fbb2b5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57810e3fbb2b5')) {function content_57810e3fbb2b5($_smarty_tpl) {?>
...
<?php }?></td><?php } ?></tr><?php } ?></table></div><!--added this div for Temporarily --><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value=='0'){?><div class="row-fluid"><!-- SalesPlatform.ru begin --><div class="emptyRecordsDiv"><?php echo vtranslate('LBL_NO',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
.</div><!--<div class="emptyRecordsDiv"><?php echo vtranslate('LBL_EQ_ZERO',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['RELATED_MODULE']->value,$_smarty_tpl->tpl_vars['RELATED_MODULE']->value);?>
 <?php echo vtranslate('LBL_FOUND',$_smarty_tpl->tpl_vars['MODULE']->value);?>
.</div>--><!-- SalesPlatform.ru end --></div><?php }?></div>
<?php }} ?>