...
class Vtigersync_Config_Config {
    public $recipient_url = 'http://crmturizm1.vordoom.net/webservice.php';
    public $username = 'vordoom';
    public $user_access_key = 'aFpvB7Y3avJtZ1WD';
