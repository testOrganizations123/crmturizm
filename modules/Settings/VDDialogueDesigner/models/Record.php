...
class Settings_VDDialogueDesigner_Record_Model extends Settings_Vtiger_Record_Model {
	...
	public function getRecordLinks() {
		...
		$recordLinks = array(
				array(
						...
						'linklabel' => 'LBL_EDIT',
						'linkurl' => "javascript:Settings_VDDialogueDesigner_List_Js.triggerCreate('".$this->getEditViewUrl()."');",
						'linkicon' => 'icon-pencil'
				),
				array(
						'linktype' => 'LISTVIEWRECORD',
						'linklabel' => 'LBL_DELETE',
						'linkurl' => "javascript:Settings_VDDialogueDesigner_List_Js.triggerCreate('".$this->getDeleteUrl()."');",
						'linkicon' => 'icon-trash'
				)
		);
