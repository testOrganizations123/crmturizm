...
class Reports_ScheduleReports_Model extends Vtiger_Base_Model {
	...
	public function sendEmail() {
		...
		if ($reportFormat == 'CSV') {
                        ...
                        $oReportRun = ReportRunCSV::getInstance($this->get('reportid'));
	...
	function getNextTriggerTime() {
		require_once 'modules/com_vtiger_workflow/VtigerWorkflowManager.inc';
	...
	public static function runScheduledReports() {
		vimport('~~modules/com_vtiger_workflow/VtigerWorkflowUtils.php');
