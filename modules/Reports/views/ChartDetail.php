...
class Reports_ChartDetail_View extends Vtiger_Index_View {
	...
	function preProcess(Vtiger_Request $request) {
		...
		$reportModel->setModule('Reports');
                ...
                $viewer->assign('WIDGET', $reportModel->report->widget);
		...
		$viewer->assign('SECONDARY_MODULE_RECORD_STRUCTURES', $secondaryModuleRecordStructures);
                //echo '<pre>';print_r ($secondaryModuleRecordStructures);
        ...
        //$fieldModel = Vtiger_Field_Model::getInstance($moduleModel);

		$reportChartModel = Reports_Chart_Model::getInstanceById($reportModel);
                //echo '<pre>';print_r( $fieldModel->getReportFilterColumnName() );
