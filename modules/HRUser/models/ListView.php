 ...
 */
class HRUser_ListView_Model extends Vtiger_ListView_Model {
...
//echo '<pre>';print_r($listResult);echo '</pre>';die();
		...
		foreach($listViewEntries as $recordId => $record) {
			...
			$listViewRecordModels[$recordId] = $moduleModel->getRecordFromArray($record, $rawData);
                        $listViewRecordModels[$recordId]->set('solary', $rawData['office']);
		}
               // echo '<pre>';print_r($listViewRecordModels);echo '</pre>';die();
	...
	function getQuery() {
		...
		$listQuery = $queryGenerator->getQuery();
                $query = "SELECT CONCAT (vtiger_users.first_name, ' ',vtiger_users.last_name) as name_hruser, vtiger_office.office as office, vtiger_hruser.position, vtiger_users.id FROM vtiger_users LEFT JOIN vtiger_hruser ON vtiger_users.id = vtiger_hruser.hruserid LEFT JOIN vtiger_office ON vtiger_office.officeid=vtiger_users.office WHERE vtiger_users.id > 0 ";
                $listQuery = $query;
                //echo '<pre>';print_r($listQuery);echo '</pre>';die();
		return $listQuery;
	}
	/**
