function renderWebix(i) {

    var table =  window.offices[i];

    var dtable = new webix.ui({
        container: "tableWorkers_" + i,
        view: "datatable",
        width: 1000,
        columns: [
            {id: "name", header: "Сотрудник", width: 238},
            {id: "cost_hours", header: "сумма / час, руб", width: 150, editor: "text"},
            {id: "percent1", header: "1 этап, %", width: 100, editor: "text"},
            {id: "percent2", header: "2 этап, %", width: 100, editor: "text"},
            {id: "percent3", header: "3 этап, %", width: 100, editor: "text"},
            {id: "percent4", header: "4 этап, %", width: 100, editor: "text"}
        ],
