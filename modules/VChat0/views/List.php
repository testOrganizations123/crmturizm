...
class VChat_List_View extends Vtiger_Index_View {
	...
	function preProcess(Vtiger_Request $request, $display=true) {
		...
		$viewer->assign('Test2', "Настройки");
		//$viewer->assign('Test2', '====<img src="layouts/vlayout/skins/softed/images/setting.png" alt="Настройки CRM" title="Настройки CRM">');
		
		//seachUser($word,$channel);
		require_once("modules/VChat/views/SearchUser.php");
		$listUsers=seachUser($word,$channel);
		$viewer->assign('listUsers', $listUsers);
	...
	function process (Vtiger_Request $request) {
		...
		//$viewer->assign('Test2', '<img src="layouts/vlayout/skins/softed/images/setting.png" alt="Настройки CRM" title="Настройки CRM">");
		$viewer->view('VCahtContents.tpl', $moduleName);
	}
