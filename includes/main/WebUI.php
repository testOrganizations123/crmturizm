...
class Vtiger_WebUI extends Vtiger_EntryPoint {
	...
	function process (Vtiger_Request $request) {
		...
		// Better place this here as session get initiated
                ...
                if($request->get('mode') != 'reset' && $request->get('mode') != 'saveExpressTask' && $request->get('action') != 'Login')
		...
		$response = false;
                ...
                if($module =="Potentials" and $viewid == ""){
                    $_REQUEST['viewname'] = 79;
                        $request->setGlobal('viewname',79);
               }
		...
		try {
			...
			if (!empty($action)) {
				...
				$componentName = $view;
                        ...
                        //echo $componentType.$componentName.$qualifiedModuleName; die();
			$handlerClass = Vtiger_Loader::getComponentClassName($componentType, $componentName, $qualifiedModuleName);
                        //echo $handlerClass; die();
