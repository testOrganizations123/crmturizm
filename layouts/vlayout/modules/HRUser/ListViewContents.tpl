	...
	<table class="table table-bordered listViewEntriesTable">
		<thead>
			<tr class="listViewHeaders">
				...
				{foreach key=name_head item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
				<th nowrap {if $LISTVIEW_HEADER@last} colspan="2" {/if}>
					<a href="javascript:void(0);" class="listViewHeaderValues" >{if $name_head eq 'solary'}Офис{else}{vtranslate($LISTVIEW_HEADER->get('label'), $MODULE)}{/if}
						</a>
				</th>
				{/foreach}
			</tr>
