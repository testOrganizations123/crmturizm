...
Vtiger_List_Js("Calendar_List_Js",{
    ...
    registerExpressTask : function() {
        var thisInstance = this;
       
        jQuery('#addExTask').on('click', function(e){
             var params = {url : 'express.php'};
             var aDeferred = jQuery.Deferred();
            e.stopPropagation();
            app.showModalWindow(params,function(data) {
