                                    ...
                                    <div id="vtlib_modulemanager_import_div">
                                        <form method="POST" action="index.php">
                                            ...
                                            <table class='tableHeading' cellpadding=5 cellspacing=0 border=0 width=100%>
                                                ...
                                                <tr>
                                                    <td>{vtranslate('Related field updated successfully!', $MODULE)} <a href="index.php?module=ModuleCreator&parent=Settings&view=Relations&modulename={$modulename}">{vtranslate('Back to relations list', $MODULE)}</a></td>
                                                </tr>
                                            </table>
