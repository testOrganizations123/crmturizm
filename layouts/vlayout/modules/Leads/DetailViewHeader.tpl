				...
				<div class="row-fluid">
					...
					<div class="span7">
						...
						<div class="btn-toolbar pull-right">
							...
							<a class="btn" onclick="foulReady()">Замечание</a></span>
						</div>
                        {else if $ERRORBUTTON}
						<div class="btn-toolbar pull-right">
							<span class="btn-group" id="createFoul"><a class="quickCreateModule btn" data-name="FoulList" data-url="index.php?module=FoulList&view=QuickCreateAjax&target={$RECORD->getId()}" href="javascript:void(0)">Добавить Замечание</a></span>
						</div>
							{/if}


						<div class="pull-right detailViewButtoncontainer hide">
