...
jQuery(document).ready(function(){
    jQuery('select[name="eventstatus"]').on('change', function(){
        var value = jQuery(this).val();
        if (value == 'Продажа'){
            jQuery('textarea[name="oldEvent"]').removeAttr('required').prev('label').html('Что сделано по предыдущей задаче?');
            jQuery('textarea[name="newEvent"]').removeAttr('required').hide().prev('label').hide();
            jQuery('input[name="date_start"]').removeAttr('required').parent('div').parent('div').parent('div').parent('span').parent('div').parent('div').hide();
            jQuery('input[name="time_start"]').removeAttr('required');
            jQuery('select[name="taskpriority"]').removeAttr('required').parent('div').hide();
        } else if (value == 'Planned'){
            jQuery('textarea[name="oldEvent"]').attr('required', 'true').prev('label').html('Что сделано по предыдущей задаче?<span class="redColor">*</span>');
            jQuery('textarea[name="newEvent"]').attr('required', 'true').show().prev('label').show();
            jQuery('input[name="date_start"]').attr('required', 'true').parent('div').parent('div').parent('div').parent('span').parent('div').parent('div').show();
            jQuery('input[name="time_start"]').attr('required', 'true');
            jQuery('select[name="taskpriority"]').attr('required', 'true').parent('div').show();
        } else if (value == 'Новая'){
            jQuery('textarea[name="oldEvent"]').attr('required', 'true').prev('label').html('Что сделано по предыдущей задаче?<span class="redColor">*</span>');
            jQuery('textarea[name="newEvent"]').attr('required', 'true').show().prev('label').show();
            jQuery('input[name="date_start"]').attr('required', 'true').parent('div').parent('div').parent('div').parent('span').parent('div').parent('div').show();
            ...
            jQuery('textarea[name="oldEvent"]').attr('required', 'true').prev('label').html('Причина отказа?<span class="redColor">*</span>');
            jQuery('textarea[name="newEvent"]').removeAttr('required').hide().prev('label').hide();
            jQuery('input[name="date_start"]').removeAttr('required').parent('div').parent('div').parent('div').parent('span').parent('div').parent('div').hide();
            jQuery('input[name="time_start"]').removeAttr('required');
            jQuery('select[name="taskpriority"]').removeAttr('required').parent('div').hide();
