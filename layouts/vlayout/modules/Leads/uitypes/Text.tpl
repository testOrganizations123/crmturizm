...
{if $FIELD_MODEL->getFieldName() eq 'cf_1103'}{assign var=fval value=$FIELD_MODEL->set('fieldvalue', '')}{/if}
{if ($FIELD_MODEL->get('uitype') eq '19' || $FIELD_MODEL->get('uitype') eq '20') && $MODE eq 'VDDialogueDesigner'}
