        ...
        <div class="form-group">
                           ...
                           {/if}
                            <div class="input-group">
                                ...
                                <input style="height: 26px;" id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->get('name')}{$key_air}" type="text" class="form-control datetimepicker vilet depvilet" onchange='validDate(this)' {if $FIELD_MODEL->isMandatory() eq true} required{/if} name="{$FIELD_MODEL->getFieldName()}[]"
value="{$FIELD_VALUE.$key_air}"  />
        ...
        <div class="form-group">
                           ...
                           {/if}
                            <div class="input-group">
                                ...
                                <input style="height: 26px;" id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->get('name')}{$key_air}" type="text" class="form-control datetimepicker prilet depprilet" onchange='validDate2(this)' {if $FIELD_MODEL->isMandatory() eq true} required{/if} name="{$FIELD_MODEL->getFieldName()}[]"
value="{$FIELD_VALUE.$key_air}"  />
                               <span style="cursor: pointer;" class="input-group-addon"><i class="fa fa-calendar"></i></span> 
 ...
 {if $opportunity_type eq "Авиа билеты" || $opportunity_type eq "ЖД билеты"}
    <div class="span1 ticket rail addShow" style="width: 13%; padding-right: 0;margin-left:1%">
        <div class="form-group">
