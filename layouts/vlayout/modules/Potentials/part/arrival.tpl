...
{strip}
<div class="row-fluid compressed flite" style="margin-top: 25px;">
               <!-- Обратно авиакомпания --> 
    ...
    <div class="span3 width15 rail addShow" style="width: {$width15}; padding-right: 0;margin-left:1%"> 
        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class='form-control  ' name='{$FIELD_MODEL->getFieldName()}_rail[]' {if $FIELD_MODEL->isMandatory() eq true} required{/if} data-selected-value='{$FIELD_MODEL->get('fieldvalue')}' value="{$FIELD_VALUE}">
         ...
         <div class="form-group">
                            ...
                            <div class="">
                                ...
                                <select class='form-control ticket turPaket addShow ' name='{$FIELD_MODEL->getFieldName()}[]' {if $FIELD_MODEL->isMandatory() eq true} required{/if} data-selected-value='{$FIELD_MODEL->get('fieldvalue')}'>
                                 ...
                                 {/if} 
                                 {if $opportunity_type eq "ЖД билеты" || $opportunity_type eq ""}
                                      <input value="{$FIELD_VALUE}" class='form-control rail addShow ' name='{$FIELD_MODEL->getFieldName()}_rail[]' {if $FIELD_MODEL->isMandatory() eq true} required{/if} data-selected-value='{$FIELD_MODEL->get('fieldvalue')}'>
                                 {/if}
                            </div>
                        </div>
    </div>
                                    <!-- Обратно времы вылета -->
    <div class="span3 width14" style="width: {$width14}; padding-right: 0;margin-left:1%">
         <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input style="height: 26px;" id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->get('name')}" type="text" class="form-control datetimepicker vilet arrvilet" onchange='validDate(this)' {if $FIELD_MODEL->isMandatory() eq true} required{/if} name="{$FIELD_MODEL->getFieldName()}[]"
value="{$FIELD_VALUE}"  />
    ...
    <div class="span3 width14" style="width: {$width14}; padding-right: 0;margin-left:1%">
        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input style="height: 26px;" id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->get('name')}" type="text" class="form-control datetimepicker prilet arrprilet" onchange='validDate2(this)' {if $FIELD_MODEL->isMandatory() eq true} required{/if} name="{$FIELD_MODEL->getFieldName()}[]"
value="{$FIELD_VALUE}"  />
                               <span style="cursor: pointer;" class="input-group-addon"><i class="fa fa-calendar"></i></span> 
 ...
 {if $opportunity_type eq "" || $opportunity_type eq "Авиа билеты" || $opportunity_type eq "ЖД билеты"}
    <div class="span1 {if $opportunity_type eq ""}hide{/if} ticket addShow" style="width: 13%; padding-right: 0;margin-left:1%">
        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select class='chzn-select form-control {if $OCCUPY_COMPLETE_WIDTH} row-fluid-fluid {/if} listTurist listTuristPrice' multiple name='{$FIELD_MODEL->getFieldName()}[][]' {if $FIELD_MODEL->isMandatory() eq true} required{/if} data-selected-value='{$FIELD_MODEL->get('fieldvalue')}' style="width:160px;">
    ...
    {if $opportunity_type eq "Авиа билеты" || $opportunity_type eq "ЖД билеты" || $opportunity_type eq ""}
            <div class="span4 ticket rail addShow" style="width: 100px; padding-right: 0;margin-left:1%">
                <span>Цена билета:</span>
                
            </div>
            <div class="span2 ticket rail addShow" style="width: 13%; padding-right: 0;margin-left:1%">
