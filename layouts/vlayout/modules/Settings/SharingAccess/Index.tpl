						...
						<td class="triggerCustomSharingAccess">
							<div class="row-fluid">
								...
								<div class="span6">
									...
									<button type="button" class="btn btn-mini vtButton arrowUp row-fluid hide" data-handlerfor="fields" data-togglehandler="9-rules"><img src="layouts/vlayout/skins/images/Arrow-up.png"></img></button></div>
							</div>
						</td>
					</tr>
