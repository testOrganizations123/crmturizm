...
{strip}
    ...
    <button type="button" class="btn addButton" data-current="1" onClick="addAnswerModuleDefault(this);"><strong>{vtranslate('LBL_TYPEANSWER_MODULE_ADD', $MODULE)}</strong></button>
