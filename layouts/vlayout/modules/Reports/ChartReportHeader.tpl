            ...
            <div class="reportHeader row-fluid">
                ...
                <div class='span4'>
                    <div class="btn-toolbar pull-right">
                        ...
                        <div class="btn-group">
                            {if count($WIDGET) gt 1 }
                                    <button onclick='Vtiger_Detail_Js.deleteWidgetReports(this)' data-id="{$WIDGET['linkid']}" type="button" class="cursorPointer btn btn-success">
                                        <strong>{vtranslate('Widget',$MODULE)}</strong>
                                    </button>
                             {else}  
                            <button onclick='Vtiger_Detail_Js.registerWidgetReports(this);' data-name='{ZEND_JSON::encode($REPORT_MODEL->getName())}' data-id="{$RECORD}" type="button" class="cursorPointer btn">
                                <strong>{vtranslate('Widget',$MODULE)}</strong>
                            </button>
                             {/if}
                        </div>
