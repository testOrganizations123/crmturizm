            ...
            <div class="row-fluid">
                {if $SQL_QUERY}
                    <div class="row-fluid block padding1per">
                        ...
                        <input id="sql_RECORD_ID" value="{$RECORD_ID}" name="sql_validate" type="hidden" />
                            <table class="table table-bordered blockContainer showInlineTable equalSplit">
                                
                                {foreach key=FIELD_NAME_SQL item=FIELD_SQL from=$INPUT}
                                    <tr>
                                        ...
                                        <td class="fieldValue large">
                                            <span class="span10">
                                                <input class="large selected_fields" name="selected_fields[inputs][]" {if $FIELD_SQL['required']}required{/if} value="{$FIELD_SQL['value']}" />
                                            </span>
                                        </td>
