...
<div id='filterContainer' class='row-fluid filterContainer hide' style="z-index: 20;">
	...
	<div class="allConditionContainer conditionGroup contentsBackground well">
		...
		<div class="contents">
          ...
          <div class="row-fluid textAlignCenter">
						<button class="btn btn-success generateReport" data-mode="save" onclick="Vtiger_DashBoard_Js.registerSaveOrGenerateReportEvent({$WIDGET->get('linkid')},{$RECORD});return false;" value="{vtranslate('LBL_SAVE',$MODULE)}">
