...
jQuery.Class("PDFMaker_CkEditor_Js", {}, {
    ...
    registerEvents: function() {
        ...
        /*var textAreaBodyElement = jQuery('#body');
         ckEditorInstance.loadCkEditor(textAreaBodyElement);
         var textAreaHeaderElement = jQuery('#header');
         ckEditorInstance.loadCkEditor(textAreaHeaderElement);
         var textAreaFooterElement = jQuery('#footer');
         ckEditorInstance.loadCkEditor(textAreaFooterElement);*/
    }
});
